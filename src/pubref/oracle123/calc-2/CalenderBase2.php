...
public function CatchDate($i, $iModJZ){
                    if($this->IdxYearPrev!=$i){
                        if($this->IdxYearPrev>0){
                            $this->IdxYearDelta=$i-$this->IdxYearPrev;
                            if(!isset($this->YearSpan[$this->IdxYearDelta])){
                                $this->YearSpan[$this->IdxYearDelta]=0;
                            }
                            $this->YearSpan[$this->IdxYearDelta] +=1;
                        }
                        $this->IdxYearPrev=$i;
                    }
                    $this->RecordedDateArr[$iModJZ] +=1;
}
